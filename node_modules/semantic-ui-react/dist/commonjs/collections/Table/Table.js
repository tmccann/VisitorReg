...
var Table = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var headerElement = hasHeaderRows && /*#__PURE__*/React.createElement(_TableHeader.default, null, _TableRow.default.create(headerRow, headerShorthandOptions), (0, _map2.default)(headerRows, function (data) {
    return _TableRow.default.create(data, headerShorthandOptions);
  }));
  return /*#__PURE__*/React.createElement(ElementType, (0, _extends2.default)({}, rest, {
    className: classes,
    ref: ref
  }), headerElement, /*#__PURE__*/React.createElement(_TableBody.default, null, renderBodyRow && (0, _map2.default)(tableData, function (data, index) {
    return _TableRow.default.create(renderBodyRow(data, index));
  })), footerRow && /*#__PURE__*/React.createElement(_TableFooter.default, null, _TableRow.default.create(footerRow)));
});
