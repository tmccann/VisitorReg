...
var _excluded = ["icon", "input", "minCharacters", "noResultsMessage", "showNoResults"],
  _excluded2 = ["childKey"],
  _excluded3 = ["childKey"];
...
var Search = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var _props$icon = props.icon,
    ...
    input = _props$input === void 0 ? 'text' : _props$input,
    ...
    _props$showNoResults = props.showNoResults,
    showNoResults = _props$showNoResults === void 0 ? true : _props$showNoResults,
    rest = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded);
  return /*#__PURE__*/React.createElement(SearchInner, (0, _extends2.default)({
    icon: icon,
    input: input,
  ...
  function SearchInner() {
    ...
    _this.renderResult = function (_ref2, index, _array, offset) {
      var childKey = _ref2.childKey,
        result = (0, _objectWithoutPropertiesLoose2.default)(_ref2, _excluded2);
      if (offset === void 0) {
        offset = 0;
      }
      ...
      return /*#__PURE__*/React.createElement(_SearchResult.default, (0, _extends2.default)({
    ...
    _this.renderCategories = function () {
      ...
      return (0, _map2.default)(categories, function (_ref3) {
        var childKey = _ref3.childKey,
          category = (0, _objectWithoutPropertiesLoose2.default)(_ref3, _excluded3);
        ...
        return /*#__PURE__*/React.createElement(_SearchCategory.default, categoryProps, category.results.map(renderFn));
      });
    };
    ...
    _this.renderResultsMenu = function () {
      ...
      return /*#__PURE__*/React.createElement(_SearchResults.default, {
