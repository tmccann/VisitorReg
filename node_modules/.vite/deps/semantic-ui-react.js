...
var someByType = function someByType2(children, type) {
  return some_default(import_react.Children.toArray(children), {
    type
  });
};
var findByType = function findByType2(children, type) {
  return find_default(import_react.Children.toArray(children), {
    type
  });
};
...
function createShorthand(Component4, mapValueToProps, val, options) {
  if (options === void 0) {
    options = {};
  }
  if (!ReactIs.isValidElementType(Component4)) {
  ...
  if (typeof props.children === "function") {
    return props.children(Component4, _extends({}, props, {
      children: void 0
    }));
  }
  if (valIsPrimitiveValue || valIsPropsObject) {
    return React2.createElement(Component4, props);
  }
  if (valIsFunction) {
    if (true) {
      if (!DEPRECATED_CALLS[Component4]) {
        DEPRECATED_CALLS[Component4] = true;
        console.warn('Warning: There is a deprecated shorthand function usage for "' + Component4 + '". It is deprecated and will be removed in v3 release. Please follow our upgrade guide: https://github.com/Semantic-Org/Semantic-UI-React/pull/4029');
      }
    }
    return val(Component4, props, props.children);
  }
}
function createShorthandFactory(Component4, mapValueToProps) {
  if (!ReactIs.isValidElementType(Component4)) {
    throw new Error("createShorthandFactory(): Component should be a valid element type.");
  }
  return function(val, options) {
    return createShorthand(Component4, mapValueToProps, val, options);
  };
}
...
// node_modules/semantic-ui-react/dist/es/lib/getComponentType.js
function getComponentType(props, options) {
  if (options === void 0) {
    options = {};
  }
  var _options = options, defaultAs = _options.defaultAs, getDefault = _options.getDefault;
...
var getComponentType_default = getComponentType;

// node_modules/semantic-ui-react/dist/es/lib/getUnhandledProps.js
var getUnhandledProps = function getUnhandledProps2(Component4, props) {
  var _Component$handledPro = Component4.handledProps, handledProps = _Component$handledPro === void 0 ? [] : _Component$handledPro;
...
var useIsomorphicLayoutEffect = isBrowser_default() && true ? React4.useLayoutEffect : React4.useEffect;
...
function useClassNamesOnNode(node, className) {
  var classNameRef = React5.useRef();
  var isMounted = React5.useRef(false);
...
var IconGroup = React10.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props, {
    defaultAs: "i"
  });
  return React10.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
...
var Icon = React11.forwardRef(function(props, ref2) {
  ...
  return React11.createElement(ElementType, _extends({}, rest, ariaProps, {
    className: classes,
    onClick: handleClick,
    ref: ref2
  }));
...
var MemoIcon = React11.memo(Icon);
...
function useTrigger(trigger, triggerRef) {
  ...
  if (trigger) {
    ...
    return [ref2, React13.cloneElement(trigger, {
      ref: ref2
    })];
  }
  return [ref2, null];
...
function usePortalElement(node, userRef) {
  ...
  if (React14.isValidElement(node)) {
    if (import_react_is.default.isForwardRef(node)) {
      return React14.cloneElement(node, {
        ref: ref2
      });
    }
...
// node_modules/semantic-ui-react/dist/es/addons/Portal/PortalInner.js
var PortalInner = React15.forwardRef(function(props, ref2) {
...
function Portal(props) {
  var children = props.children, _props$closeOnDocumen = props.closeOnDocumentClick, closeOnDocumentClick = _props$closeOnDocumen === void 0 ? true : _props$closeOnDocumen, _props$closeOnEscape = props.closeOnEscape, closeOnEscape = _props$closeOnEscape === void 0 ? true : _props$closeOnEscape, closeOnPortalMouseLeave = props.closeOnPortalMouseLeave, closeOnTriggerBlur = props.closeOnTriggerBlur, closeOnTriggerClick = props.closeOnTriggerClick, closeOnTriggerMouseLeave = props.closeOnTriggerMouseLeave, _props$eventPool = props.eventPool, eventPool = _props$eventPool === void 0 ? "default" : _props$eventPool, mountNode = props.mountNode, mouseEnterDelay = props.mouseEnterDelay, mouseLeaveDelay = props.mouseLeaveDelay, _props$openOnTriggerC = props.openOnTriggerClick, openOnTriggerClick = _props$openOnTriggerC === void 0 ? true : _props$openOnTriggerC, openOnTriggerFocus = props.openOnTriggerFocus, openOnTriggerMouseEnter = props.openOnTriggerMouseEnter;
  ...
  var contentRef = React16.useRef();
  var _useTrigger = useTrigger_default(props.trigger, props.triggerRef), triggerRef = _useTrigger[0], trigger = _useTrigger[1];
  var mouseEnterTimer = React16.useRef();
  var mouseLeaveTimer = React16.useRef();
  var latestDocumentMouseDownEvent = React16.useRef();
  ...
  var handleDocumentClick = function handleDocumentClick2(e) {
    ...
    if (!((_contentRef$current = contentRef.current) != null && _contentRef$current.contains) || // no portal
  ...
  return React16.createElement(React16.Fragment, null, open && React16.createElement(React16.Fragment, null, React16.createElement(PortalInner_default, {
    mountNode,
    ...
    ref: contentRef
  }, children), React16.createElement(import_event_stack2.default, {
    name: "mouseleave",
    on: handlePortalMouseLeave,
    pool: eventPool,
    target: contentRef
  }), React16.createElement(import_event_stack2.default, {
    name: "mouseenter",
    ...
    on: handleEscape,
    pool: eventPool
  })), trigger && React16.cloneElement(trigger, {
...
var DimmerDimmable = React17.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React17.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var DimmerInner = React18.forwardRef(function(props, ref2) {
  ...
  var containerRef = useMergedRefs(ref2, React18.useRef());
  var contentRef = React18.useRef();
  useIsomorphicLayoutEffect_default(function() {
  ...
  return React18.createElement(ElementType, _extends({}, rest, {
    className: classes,
    onClick: handleClick,
    ref: containerRef
  }), childrenContent && React18.createElement("div", {
    className: "content",
    ref: contentRef
  }, childrenContent));
});
...
// node_modules/semantic-ui-react/dist/es/modules/Dimmer/Dimmer.js
var Dimmer = React19.forwardRef(function(props, ref2) {
  ...
  if (page) {
    ...
    return React19.createElement(Portal_default, {
      closeOnEscape: false,
    ...
    }, React19.createElement(DimmerInner_default, _extends({}, rest, {
      active,
      page,
      ref: ref2
    })));
  }
  return React19.createElement(DimmerInner_default, _extends({}, rest, {
    active,
    page,
    ref: ref2
  }));
...
var ImageGroup = React20.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, size2 = props.size;
  var classes = clsx_m_default("ui", size2, className, "images");
  var rest = getUnhandledProps_default(ImageGroup, props);
  var ElementType = getComponentType_default(props);
  return React20.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var Image = React21.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React21.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  ...
  if (ElementType === "img") {
    return React21.createElement(ElementType, _extends({}, rootProps, imgTagProps, {
      className: classes,
      ref: ref2
    }));
  }
  return React21.createElement(ElementType, _extends({}, rootProps, {
    className: classes,
    href
    ...
    autoGenerateKey: false
  }), React21.createElement("img", _extends({}, imgTagProps, {
    ref: ref2
  })));
});
...
var LabelDetail = React22.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React22.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var LabelGroup = React23.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React23.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/Label/Label.js
var Label = React24.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React24.createElement(ElementType, _extends({}, rest, {
      className: classes,
      onClick: handleClick,
      ref: ref2
    }), children);
...
var ButtonContent = React25.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React25.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ButtonGroup = React26.forwardRef(function(props, ref2) {
  ...
  if (isNil_default(buttons)) {
    return React26.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), childrenUtils_exports.isNil(children) ? content : children);
  }
...
var ButtonOr = React27.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React27.createElement(ElementType, _extends({}, rest, {
    className: classes,
    "data-text": text,
    ref: ref2
  }));
...
var Button = React28.forwardRef(function(props, ref2) {
  ...
  var elementRef = useMergedRefs(ref2, React28.useRef());
  ...
  if (!isNil_default(label)) {
    ...
    return React28.createElement(ElementType, _extends({}, rest, {
      className: containerClasses,
      onClick: handleClick
    }), labelPosition === "left" && labelElement, React28.createElement("button", {
...
var ModalActions = React29.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React29.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var ModalContent = React30.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React30.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ModalDescription = React31.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("description", className);
  var rest = getUnhandledProps_default(ModalDescription, props);
  var ElementType = getComponentType_default(props);
  return React31.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ModalDimmer = React32.forwardRef(function(props, ref2) {
  ...
  var elementRef = useMergedRefs(ref2, React32.useRef());
  ...
  return React32.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: elementRef
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ModalHeader = React33.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
  var rest = getUnhandledProps_default(ModalHeader, props);
  var ElementType = getComponentType_default(props);
  return React33.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/modules/Modal/Modal.js
var Modal = React34.forwardRef(function(props, ref2) {
  var actions = props.actions, basic = props.basic, _props$centered = props.centered, centered = _props$centered === void 0 ? true : _props$centered, children = props.children, className = props.className, closeIcon = props.closeIcon, _props$closeOnDimmerC = props.closeOnDimmerClick, closeOnDimmerClick = _props$closeOnDimmerC === void 0 ? true : _props$closeOnDimmerC, _props$closeOnDocumen = props.closeOnDocumentClick, closeOnDocumentClick = _props$closeOnDocumen === void 0 ? false : _props$closeOnDocumen, content = props.content, _props$dimmer = props.dimmer, dimmer = _props$dimmer === void 0 ? true : _props$dimmer, _props$eventPool = props.eventPool, eventPool = _props$eventPool === void 0 ? "Modal" : _props$eventPool, header = props.header, size2 = props.size, style = props.style, trigger = props.trigger;
  ...
  var _React$useState = React34.useState({}), legacyStyles = _React$useState[0], setLegacyStyles = _React$useState[1];
  var _React$useState2 = React34.useState(false), scrolling = _React$useState2[0], setScrolling = _React$useState2[1];
  var _React$useState3 = React34.useState(function() {
    return isBrowser_default() && isLegacy();
  }), legacy = _React$useState3[0];
  var elementRef = useMergedRefs(ref2, React34.useRef());
  var dimmerRef = React34.useRef();
  var animationRequestId = React34.useRef();
  var latestDocumentMouseDownEvent = React34.useRef();
  ...
  var renderContent = function renderContent2(rest2) {
    ...
    return React34.createElement(ElementType, _extends({}, rest2, {
      className: classes,
      ref: elementRef,
      style: _extends({}, legacyStyles, style)
    }), closeIconJSX, childrenUtils_exports.isNil(children) ? React34.createElement(React34.Fragment, null, ModalHeader_default.create(header, {
      autoGenerateKey: false
  ...
  if (!isBrowser_default()) {
    return React34.isValidElement(trigger) ? trigger : null;
  }
  ...
  return React34.createElement(Portal_default, _extends({
...
// node_modules/semantic-ui-react/dist/es/addons/Confirm/Confirm.js
var Confirm = React35.forwardRef(function(props, ref2) {
  var _props$cancelButton = props.cancelButton, cancelButton = _props$cancelButton === void 0 ? "Cancel" : _props$cancelButton, _props$confirmButton = props.confirmButton, confirmButton = _props$confirmButton === void 0 ? "OK" : _props$confirmButton, _props$content = props.content, content = _props$content === void 0 ? "Are you sure?" : _props$content, header = props.header, open = props.open, _props$size = props.size, size2 = _props$size === void 0 ? "small" : _props$size;
  ...
  return React35.createElement(Modal_default, _extends({}, rest, openProp, {
    size: size2,
    ...
    autoGenerateKey: false
  }), React35.createElement(Modal_default.Actions, null, Button_default.create(cancelButton, {
    autoGenerateKey: false,
...
var MenuHeader = React36.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
  var rest = getUnhandledProps_default(MenuHeader, props);
  var ElementType = getComponentType_default(props);
  return React36.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var MenuItem = React37.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React37.createElement(ElementType, _extends({}, rest, {
      className: classes,
      onClick: handleClick,
      ref: ref2
    }), children);
...
var MenuMenu = React38.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React38.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/collections/Menu/Menu.js
var Menu = React39.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React39.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
// node_modules/semantic-ui-react/dist/es/addons/Pagination/Pagination.js
var Pagination = React41.forwardRef(function(props, ref2) {
  var _props$ariaLabel = props["aria-label"], ariaLabel = _props$ariaLabel === void 0 ? "Pagination Navigation" : _props$ariaLabel, _props$boundaryRange = props.boundaryRange, boundaryRange = _props$boundaryRange === void 0 ? 1 : _props$boundaryRange, disabled = props.disabled, _props$ellipsisItem = props.ellipsisItem, ellipsisItem = _props$ellipsisItem === void 0 ? "..." : _props$ellipsisItem, _props$firstItem = props.firstItem, firstItem = _props$firstItem === void 0 ? {
    "aria-label": "First item",
    content: "«"
  } : _props$firstItem, _props$lastItem = props.lastItem, lastItem = _props$lastItem === void 0 ? {
    "aria-label": "Last item",
    content: "»"
  } : _props$lastItem, _props$nextItem = props.nextItem, nextItem = _props$nextItem === void 0 ? {
    "aria-label": "Next item",
    content: "⟩"
  } : _props$nextItem, _props$pageItem = props.pageItem, pageItem = _props$pageItem === void 0 ? {} : _props$pageItem, _props$prevItem = props.prevItem, prevItem = _props$prevItem === void 0 ? {
    "aria-label": "Previous item",
    content: "⟨"
  } : _props$prevItem, _props$siblingRange = props.siblingRange, siblingRange = _props$siblingRange === void 0 ? 1 : _props$siblingRange, totalPages = props.totalPages;
  var _useAutoControlledVal = useAutoControlledValue_default({
  ...
  return React41.createElement(Menu_default, _extends({}, rest, {
    ...
    return PaginationItem_default.create(paginationItemTypes[type], {
      defaultProps: {
        content: value,
        disabled,
        value
...
var Checkbox = React42.forwardRef(function(props, ref2) {
  var className = props.className, disabled = props.disabled, label = props.label, id = props.id, name = props.name, radio = props.radio, readOnly = props.readOnly, slider = props.slider, tabIndex = props.tabIndex, toggle = props.toggle, _props$type = props.type, type = _props$type === void 0 ? "checkbox" : _props$type, value = props.value;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.checked,
  ...
  var inputRef = useMergedRefs(React42.useRef(), ref2);
  var labelRef = React42.useRef();
  var isClickFromMouse = React42.useRef();
  useIsomorphicLayoutEffect_default(function() {
    if (inputRef.current) {
  ...
  var labelElement = createHTMLLabel(label, {
    ...
    autoGenerateKey: false
  }) || React42.createElement("label", {
    htmlFor: id
  });
  return React42.createElement(ElementType, _extends({}, rest, {
    className: classes,
    onClick: handleClick,
    onChange: handleChange,
    onMouseDown: handleMouseDown,
    onMouseUp: handleMouseUp
  }), React42.createElement("input", _extends({}, htmlInputProps2, {
    checked,
    className: "hidden",
    disabled,
    id,
    ...
    type,
    value
  })), React42.cloneElement(labelElement, {
    ref: labelRef
  }));
});
...
// node_modules/semantic-ui-react/dist/es/addons/Radio/Radio.js
var Radio = React43.forwardRef(function(props, ref2) {
  var slider = props.slider, toggle = props.toggle, _props$type = props.type, type = _props$type === void 0 ? "radio" : _props$type;
  var rest = getUnhandledProps_default(Radio, props);
  var radio = !(slider || toggle) || void 0;
  return React43.createElement(Checkbox_default, _extends({}, rest, {
    type,
    radio,
    slider,
    toggle,
...
var Flag = React44.forwardRef(function(props, ref2) {
  ...
  return React44.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var MemoFlag = React44.memo(Flag);
...
var DropdownDivider = React45.forwardRef(function(props, ref2) {
  var className = props.className;
  var classes = clsx_m_default("divider", className);
  var rest = getUnhandledProps_default(DropdownDivider, props);
  var ElementType = getComponentType_default(props);
  return React45.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var DropdownItem = React46.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React46.createElement(ElementType, _extends({}, rest, ariaOptions, {
      className: classes,
      onClick: handleClick,
      ref: ref2
    }), children);
...
var DropdownHeader = React47.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React47.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var DropdownMenu = React48.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React48.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var DropdownSearchInput = React49.forwardRef(function(props, ref2) {
  var _props$autoComplete = props.autoComplete, autoComplete = _props$autoComplete === void 0 ? "off" : _props$autoComplete, className = props.className, tabIndex = props.tabIndex, _props$type = props.type, type = _props$type === void 0 ? "text" : _props$type, value = props.value;
  var handleChange = function handleChange2(e) {
  ...
  return React49.createElement(ElementType, _extends({
...
var DropdownText = React50.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("divider", className);
  var rest = getUnhandledProps_default(DropdownText, props);
  var ElementType = getComponentType_default(props);
  return React50.createElement(ElementType, _extends({
    "aria-atomic": true,
    "aria-live": "polite",
    role: "alert"
  }, rest, {
...
function getMenuOptions(config) {
  ...
  if (allowAdditions && search && searchQuery && !some_default(filteredOptions, {
    ...
    var additionLabelElement = React51.isValidElement(additionLabel) ? React51.cloneElement(additionLabel, {
      key: "addition-label"
    }) : additionLabel || "";
    var addItem = {
      key: "addition",
      ...
      text: [additionLabelElement, React51.createElement("b", {
        key: "addition-query"
      }, searchQuery)],
      value: searchQuery,
      className: "addition",
...
function getSelectedIndex(config) {
  ...
  var enabledIndexes = reduce_default(menuOptions, function(memo3, item, index) {
    if (!item.disabled)
      memo3.push(index);
    return memo3;
  }, []);
...
// node_modules/semantic-ui-react/dist/es/modules/Dropdown/Dropdown.js
var _excluded = ["additionLabel", "additionPosition", "closeOnBlur", "closeOnEscape", "deburr", "icon", "minCharacters", "noResultsMessage", "openOnFocus", "renderLabel", "searchInput", "selectOnBlur", "selectOnNavigation", "wrapSelection"];
...
function renderItemContent(item) {
  ...
  return {
    content: import_react2.default.createElement(import_react2.default.Fragment, null, Flag_default.create(flag), Image_default.create(image), text)
  };
}
var Dropdown = import_react2.default.forwardRef(function(props, ref2) {
  var _props$additionLabel = props.additionLabel, additionLabel = _props$additionLabel === void 0 ? "Add " : _props$additionLabel, _props$additionPositi = props.additionPosition, additionPosition = _props$additionPositi === void 0 ? "top" : _props$additionPositi, _props$closeOnBlur = props.closeOnBlur, closeOnBlur = _props$closeOnBlur === void 0 ? true : _props$closeOnBlur, _props$closeOnEscape = props.closeOnEscape, closeOnEscape = _props$closeOnEscape === void 0 ? true : _props$closeOnEscape, _props$deburr = props.deburr, deburr2 = _props$deburr === void 0 ? false : _props$deburr, _props$icon = props.icon, icon = _props$icon === void 0 ? "dropdown" : _props$icon, _props$minCharacters = props.minCharacters, minCharacters = _props$minCharacters === void 0 ? 1 : _props$minCharacters, _props$noResultsMessa = props.noResultsMessage, noResultsMessage = _props$noResultsMessa === void 0 ? "No results found." : _props$noResultsMessa, _props$openOnFocus = props.openOnFocus, openOnFocus = _props$openOnFocus === void 0 ? true : _props$openOnFocus, _props$renderLabel = props.renderLabel, renderLabel = _props$renderLabel === void 0 ? renderItemContent : _props$renderLabel, _props$searchInput = props.searchInput, searchInput = _props$searchInput === void 0 ? "text" : _props$searchInput, _props$selectOnBlur = props.selectOnBlur, selectOnBlur = _props$selectOnBlur === void 0 ? true : _props$selectOnBlur, _props$selectOnNaviga = props.selectOnNavigation, selectOnNavigation = _props$selectOnNaviga === void 0 ? true : _props$selectOnNaviga, _props$wrapSelection = props.wrapSelection, wrapSelection = _props$wrapSelection === void 0 ? true : _props$wrapSelection, rest = _objectWithoutPropertiesLoose(props, _excluded);
  return import_react2.default.createElement(DropdownInner, _extends({
    additionLabel,
    additionPosition,
    closeOnBlur,
    closeOnEscape,
...
var DropdownInner = function(_Component) {
  ...
  function DropdownInner2() {
    ...
    _this.searchRef = (0, import_react2.createRef)();
    _this.sizerRef = (0, import_react2.createRef)();
    ...
    _this.renderSearchSizer = function() {
      ...
      return search && multiple && import_react2.default.createElement("span", {
        className: "sizer",
        ref: _this.sizerRef
      });
    };
          ...
          overrideProps: function overrideProps(predefinedProps) {
            return {
              onClick: function onClick(e, item) {
                predefinedProps.onClick == null || predefinedProps.onClick(e, item);
    ...
    _this.renderMenu = function() {
      ...
      if (!childrenUtils_exports.isNil(children)) {
        var menuChild = import_react2.Children.only(children);
        var className = clsx_m_default(direction, useKeyOnly(open, "visible"), menuChild.props.className);
        return (0, import_react2.cloneElement)(menuChild, _extends({
          className
        }, ariaOptions));
      }
      return import_react2.default.createElement(DropdownMenu_default, _extends({}, ariaOptions, {
        direction,
        open
  ...
  _proto.render = function render() {
    ...
    var ElementType = getComponentType_default(this.props);
    var ariaOptions = this.getDropdownAriaOptions(ElementType, this.props);
    return import_react2.default.createElement(ElementType, _extends({}, rest, ariaOptions, {
      className: classes,
      ...
      autoGenerateKey: false
    }), this.renderMenu(), open && import_react2.default.createElement(import_event_stack3.default, {
      name: "keydown",
      on: this.closeOnEscape
    }), open && import_react2.default.createElement(import_event_stack3.default, {
      name: "click",
      on: this.closeOnDocumentClick
    }), focus && import_react2.default.createElement(import_event_stack3.default, {
      name: "keydown",
...
// node_modules/semantic-ui-react/dist/es/addons/Select/Select.js
var Select = React53.forwardRef(function(props, ref2) {
  return React53.createElement(Dropdown_default, _extends({}, props, {
    selection: true,
    ref: ref2
  }));
});
...
var TextArea = React54.forwardRef(function(props, ref2) {
  var _props$rows = props.rows, rows = _props$rows === void 0 ? 3 : _props$rows, value = props.value;
  var elementRef = useMergedRefs(ref2, React54.useRef());
  var handleChange = function handleChange2(e) {
    var newValue = get_default(e, "target.value");
    invoke_default(props, "onChange", e, _extends({}, props, {
      value: newValue
  ...
  return React54.createElement(ElementType, _extends({}, rest, {
    onChange: handleChange,
    onInput: handleInput,
    ref: elementRef,
    rows,
...
var getChildMapping = function getChildMapping2(children) {
  return keyBy_default(filter_default(import_react3.Children.toArray(children), import_react3.isValidElement), "key");
};
...
function wrapChild(child, onHide, options) {
  ...
  return React55.createElement(Transition, {
    animation,
    directional,
    duration,
    key,
...
function useWrappedChildren(children, animation, duration, directional) {
  ...
  var previousChildren = React56.useRef();
  var wrappedChildren;
  ...
  if (typeof previousChildren.current === "undefined") {
    ...
    forEach_default(wrappedChildren, function(child, key) {
      ...
      if (!hasNext && hasPrev && !isLeaving) {
        wrappedChildren[key] = React56.cloneElement(prevChild, {
          visible: false
        });
        return;
      }
...
var TransitionGroup = React56.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props, {
    defaultAs: React56.Fragment
  });
  var rest = getUnhandledProps_default(TransitionGroup, props);
  return React56.createElement(ElementType, _extends({}, rest, {
    ref: ref2
...
function usePortalState(props) {
  var portalOpen = React58.useRef(false);
  var forceUpdate = useForceUpdate();
  var setPortalOpen = React58.useCallback(function(value) {
...
function TransitionablePortal(props) {
  var children = props.children, _props$transition = props.transition, transition = _props$transition === void 0 ? {
    animation: "scale",
    duration: 400
  } : _props$transition;
  var _usePortalState = usePortalState(props), portalOpen = _usePortalState[0], setPortalOpen = _usePortalState[1];
  var _React$useState = React58.useState(false), transitionVisible = _React$useState[0], setTransitionVisible = _React$useState[1];
  ...
  return React58.createElement(Portal_default, _extends({}, rest, {
    open,
    onOpen: handlePortalOpen,
    onClose: handlePortalClose
  }), React58.createElement(Transition, _extends({}, transition, {
    transitionOnMount: true,
...
var BreadcrumbDivider = React59.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, icon = props.icon;
  var classes = clsx_m_default("divider", className);
  ...
  if (!isNil_default(content)) {
    return React59.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), content);
  }
...
var BreadcrumbSection = React60.forwardRef(function(props, ref2) {
  ...
  return React60.createElement(ElementType, _extends({}, rest, {
    className: classes,
    href,
    onClick: handleClick,
    ref: ref2
...
// node_modules/semantic-ui-react/dist/es/collections/Breadcrumb/Breadcrumb.js
var Breadcrumb = React61.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React61.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var FormField = import_react4.default.forwardRef(function(props, ref2) {
  ...
  if (isNil_default(control)) {
    if (isNil_default(label)) {
      return import_react4.default.createElement(ElementType, _extends({}, rest, {
        className: classes,
        id,
        ref: ref2
      }), childrenUtils_exports.isNil(children) ? content : children);
  ...
  if (control === "input" && (type === "checkbox" || type === "radio")) {
    return import_react4.default.createElement(ElementType, {
      className: classes
    }, import_react4.default.createElement("label", null, errorLabelBefore, (0, import_react4.createElement)(control, _extends({}, ariaAttrs, controlProps)), " ", label, errorLabelAfter));
  }
  if (control === Checkbox_default || control === Radio_default) {
    return import_react4.default.createElement(ElementType, {
      className: classes
    }, errorLabelBefore, (0, import_react4.createElement)(control, _extends({}, ariaAttrs, controlProps, {
      label
    })), errorLabelAfter);
  }
  return import_react4.default.createElement(ElementType, {
    ...
    autoGenerateKey: false
  }), errorLabelBefore, (0, import_react4.createElement)(control, _extends({}, ariaAttrs, controlProps)), errorLabelAfter);
});
...
// node_modules/semantic-ui-react/dist/es/collections/Form/FormButton.js
var FormButton = React63.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? Button_default : _props$control;
  var rest = getUnhandledProps_default(FormButton, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React63.createElement(ElementType, _extends({}, rest, {
    control,
    ref: ref2
  }));
});
...
var FormCheckbox = React64.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? Checkbox_default : _props$control;
  var rest = getUnhandledProps_default(FormCheckbox, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React64.createElement(ElementType, _extends({}, rest, {
    control,
    ref: ref2
  }));
});
...
var FormDropdown = React65.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? Dropdown_default : _props$control;
  var rest = getUnhandledProps_default(FormDropdown, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React65.createElement(ElementType, _extends({}, rest, {
    control,
    ref: ref2
  }));
});
...
var FormGroup = React66.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, disabled = props.disabled, error = props.error, grouped = props.grouped, inline = props.inline, unstackable = props.unstackable, widths = props.widths;
  var classes = clsx_m_default(useKeyOnly(error, "error"), useKeyOnly(disabled, "disabled"), useKeyOnly(grouped, "grouped"), useKeyOnly(inline, "inline"), useKeyOnly(unstackable, "unstackable"), useWidthProp(widths, null, true), "fields", className);
  var rest = getUnhandledProps_default(FormGroup, props);
  var ElementType = getComponentType_default(props);
  return React66.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), children);
});
...
var Input = React67.forwardRef(function(props, _ref) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    var childElements = map_default(React67.Children.toArray(children), function(child) {
      if (child.type === "input") {
        return React67.cloneElement(child, _extends({}, htmlInputProps2, child.props, {
          ref: function ref2(c) {
            setRef(child.ref, c);
            setRef(_ref, c);
          }
    ...
    return React67.createElement(ElementType, _extends({}, rest, {
      className: classes
    }), childElements);
  }
...
// node_modules/semantic-ui-react/dist/es/collections/Form/FormInput.js
var FormInput = React68.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? Input_default : _props$control;
  var rest = getUnhandledProps_default(FormInput, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React68.createElement(ElementType, _extends({}, rest, {
    control,
    ref: ref2
  }));
});
...
var FormRadio = React69.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? Radio_default : _props$control;
  var rest = getUnhandledProps_default(FormRadio, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React69.createElement(ElementType, _extends({}, rest, {
    control,
    ref: ref2
  }));
});
...
var FormSelect = React70.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? Select_default : _props$control, options = props.options;
  var rest = getUnhandledProps_default(FormSelect, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React70.createElement(ElementType, _extends({}, rest, {
    control,
    options,
    ref: ref2
  }));
...
var FormTextArea = React71.forwardRef(function(props, ref2) {
  var _props$control = props.control, control = _props$control === void 0 ? TextArea_default : _props$control;
  var rest = getUnhandledProps_default(FormTextArea, props);
  var ElementType = getComponentType_default(props, {
    defaultAs: FormField_default
  });
  return React71.createElement(ElementType, _extends({}, rest, {
    control,
    ref: ref2
  }));
});
...
// node_modules/semantic-ui-react/dist/es/collections/Form/Form.js
var Form = React72.forwardRef(function(props, ref2) {
  ...
  return React72.createElement(ElementType, _extends({}, rest, {
    action,
    className: classes,
...
var GridColumn = React73.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React73.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), children);
});
...
var GridRow = React74.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React74.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), children);
});
...
// node_modules/semantic-ui-react/dist/es/collections/Grid/Grid.js
var Grid = React75.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React75.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), children);
});
...
var MessageContent = React76.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
  var rest = getUnhandledProps_default(MessageContent, props);
  var ElementType = getComponentType_default(props);
  return React76.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var MessageHeader = React77.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
  var rest = getUnhandledProps_default(MessageHeader, props);
  var ElementType = getComponentType_default(props);
  return React77.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var MessageItem = React78.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
  ...
  return React78.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/collections/Message/MessageList.js
var MessageList = React79.forwardRef(function(props, ref2) {
  ...
  return React79.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
...
// node_modules/semantic-ui-react/dist/es/collections/Message/Message.js
var Message = React80.forwardRef(function(props, ref2) {
  ...
  var dismissIcon = onDismiss && React80.createElement(Icon_default, {
    name: "close",
    onClick: handleDismiss
  });
  if (!childrenUtils_exports.isNil(children)) {
    return React80.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
  ...
  return React80.createElement(ElementType, _extends({}, rest, {
    ...
    autoGenerateKey: false
  }), (!isNil_default(header) || !isNil_default(content) || !isNil_default(list)) && React80.createElement(MessageContent_default, null, MessageHeader_default.create(header, {
    autoGenerateKey: false
...
var TableBody = React81.forwardRef(function(props, ref2) {
  ...
  return React81.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), children);
});
...
var TableCell = React82.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React82.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var TableHeader = React83.forwardRef(function(props, ref2) {
  ...
  return React83.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/collections/Table/TableFooter.js
var TableFooter = React84.forwardRef(function(props, ref2) {
  var _props$as = props.as, as = _props$as === void 0 ? "tfoot" : _props$as;
  var rest = getUnhandledProps_default(TableFooter, props);
  return React84.createElement(TableHeader_default, _extends({}, rest, {
    as,
    ref: ref2
  }));
});
...
var TableHeaderCell = React85.forwardRef(function(props, ref2) {
  var _props$as = props.as, as = _props$as === void 0 ? "th" : _props$as, className = props.className, sorted = props.sorted;
  ...
  return React85.createElement(TableCell_default, _extends({}, rest, {
    as,
    className: classes,
    ref: ref2
  }));
...
var TableRow = React86.forwardRef(function(props, ref2) {
  var active = props.active, _props$cellAs = props.cellAs, cellAs = _props$cellAs === void 0 ? "td" : _props$cellAs, cells = props.cells, children = props.children, className = props.className, disabled = props.disabled, error = props.error, negative = props.negative, positive = props.positive, textAlign = props.textAlign, verticalAlign = props.verticalAlign, warning2 = props.warning;
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React86.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
// node_modules/semantic-ui-react/dist/es/collections/Table/Table.js
var Table = React87.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React87.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  ...
  var headerElement = hasHeaderRows && React87.createElement(TableHeader_default, null, TableRow_default.create(headerRow, headerShorthandOptions), map_default(headerRows, function(data) {
    return TableRow_default.create(data, headerShorthandOptions);
  }));
  return React87.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), headerElement, React87.createElement(TableBody_default, null, renderBodyRow && map_default(tableData, function(data, index) {
    return TableRow_default.create(renderBodyRow(data, index));
  })), footerRow && React87.createElement(TableFooter_default, null, TableRow_default.create(footerRow)));
});
...
var Container = React88.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React88.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var Divider = React89.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React89.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var HeaderSubheader = React90.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("sub header", className);
  var rest = getUnhandledProps_default(HeaderSubheader, props);
  var ElementType = getComponentType_default(props);
  return React90.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var HeaderContent = React91.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
  var rest = getUnhandledProps_default(HeaderContent, props);
  var ElementType = getComponentType_default(props);
  return React91.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/Header/Header.js
var Header = React92.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React92.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  ...
  if (iconElement || imageElement) {
    return React92.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), iconElement || imageElement, (content || subheaderElement) && React92.createElement(HeaderContent_default, null, content, subheaderElement));
  }
  return React92.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
...
var ListDescription = React93.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default(className, "description");
  var rest = getUnhandledProps_default(ListDescription, props);
  var ElementType = getComponentType_default(props);
  return React93.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ListHeader = React94.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
  var rest = getUnhandledProps_default(ListHeader, props);
  var ElementType = getComponentType_default(props);
  return React94.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/List/ListContent.js
var ListContent = React95.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React95.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var ListIcon = React96.forwardRef(function(props, ref2) {
  ...
  return React96.createElement(Icon_default, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var ListItem = import_react5.default.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return import_react5.default.createElement(ElementType, _extends({}, valueProp, {
      role: "listitem"
    }, rest, {
      className: classes,
      onClick: handleClick,
  ...
  if (!(0, import_react5.isValidElement)(content) && isPlainObject_default(content)) {
    return import_react5.default.createElement(ElementType, _extends({}, valueProp, {
      role: "listitem"
    }, rest, {
      className: classes,
  ...
  if (iconElement || imageElement) {
    return import_react5.default.createElement(ElementType, _extends({}, valueProp, {
      ...
      onClick: handleClick,
      ref: ref2
    }), iconElement || imageElement, (content || headerElement || descriptionElement) && import_react5.default.createElement(ListContent_default, null, headerElement, descriptionElement, content));
  }
  return import_react5.default.createElement(ElementType, _extends({}, valueProp, {
    role: "listitem"
  }, rest, {
...
var ListList = React98.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  ...
  return React98.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/List/List.js
var List = React99.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React99.createElement(ElementType, _extends({
      role: "list"
    }, rest, {
      className: classes,
      ref: ref2
...
var Loader = React100.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React100.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var PlaceholderHeader = React101.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React101.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var PlaceholderImage = React102.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React102.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var PlaceholderLine = React103.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React103.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var PlaceholderParagraph = React104.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("paragraph", className);
  var rest = getUnhandledProps_default(PlaceholderParagraph, props);
  var ElementType = getComponentType_default(props);
  return React104.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/Placeholder/Placeholder.js
var Placeholder = React105.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React105.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var Rail = React106.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React106.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var RevealContent = React107.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, hidden = props.hidden, visible = props.visible;
  ...
  var ElementType = getComponentType_default(props);
  return React107.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/Reveal/Reveal.js
var Reveal = React108.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React108.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var SegmentGroup = React109.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React109.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var SegmentInline = React110.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("inline", className);
  var rest = getUnhandledProps_default(SegmentInline, props);
  var ElementType = getComponentType_default(props);
  return React110.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/Segment/Segment.js
var Segment = React111.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React111.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var StepDescription = React112.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("description", className);
  var rest = getUnhandledProps_default(StepDescription, props);
  var ElementType = getComponentType_default(props);
  return React112.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var StepTitle = React113.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("title", className);
  var rest = getUnhandledProps_default(StepTitle, props);
  var ElementType = getComponentType_default(props);
  return React113.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/Step/StepContent.js
var StepContent = React114.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React114.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var StepGroup = React115.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React115.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
// node_modules/semantic-ui-react/dist/es/elements/Step/Step.js
var Step = React116.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React116.createElement(ElementType, _extends({}, rest, {
      className: classes,
      href,
      onClick: handleClick,
      ref: ref2
...
var AccordionTitle = React117.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React117.createElement(ElementType, _extends({}, rest, {
      className: classes,
      onClick: handleClick,
      ref: ref2
    }), children);
...
var AccordionContent = React118.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React118.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var AccordionPanel = function(_Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react6.default.createElement(import_react6.default.Fragment, null, AccordionTitle_default.create(title, {
      autoGenerateKey: false,
      defaultProps: {
        active,
        index
...
var AccordionAccordion = React120.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, _props$exclusive = props.exclusive, exclusive = _props$exclusive === void 0 ? true : _props$exclusive, panels = props.panels;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.activeIndex,
    defaultState: props.defaultActiveIndex,
  ...
  return React120.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
...
// node_modules/semantic-ui-react/dist/es/modules/Accordion/Accordion.js
var Accordion = React121.forwardRef(function(props, ref2) {
  ...
  return React121.createElement(AccordionAccordion_default, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var Embed = React122.forwardRef(function(props, ref2) {
  ...
  return React122.createElement(ElementType, _extends({}, rest, {
    className: classes,
    onClick: handleClick,
    ref: ref2
  }), Icon_default.create(iconShorthand, {
    autoGenerateKey: false
  }), placeholder && React122.createElement("img", {
...
var PopupContent = React128.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
  var rest = getUnhandledProps_default(PopupContent, props);
  var ElementType = getComponentType_default(props);
  return React128.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var PopupHeader = React129.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
  var rest = getUnhandledProps_default(PopupHeader, props);
  var ElementType = getComponentType_default(props);
  return React129.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var Popup = React130.forwardRef(function(props, ref2) {
  var basic = props.basic, className = props.className, content = props.content, context = props.context, children = props.children, _props$disabled = props.disabled, disabled = _props$disabled === void 0 ? false : _props$disabled, _props$eventsEnabled = props.eventsEnabled, eventsEnabled = _props$eventsEnabled === void 0 ? true : _props$eventsEnabled, flowing = props.flowing, header = props.header, inverted = props.inverted, offset2 = props.offset, _props$pinned = props.pinned, pinned = _props$pinned === void 0 ? false : _props$pinned, popper2 = props.popper, popperDependencies = props.popperDependencies, _props$popperModifier = props.popperModifiers, popperModifiers = _props$popperModifier === void 0 ? [] : _props$popperModifier, _props$position = props.position, position = _props$position === void 0 ? "top left" : _props$position, positionFixed = props.positionFixed, size2 = props.size, style = props.style, trigger = props.trigger, wide = props.wide;
  var _React$useState = React130.useState(false), closed = _React$useState[0], setClosed = _React$useState[1];
  ...
  var positionUpdate = React130.useRef();
  var timeoutId = React130.useRef();
  var triggerRef = React130.useRef();
  var zIndexWasSynced = React130.useRef(false);
  ...
  var renderBody = function renderBody2(_ref) {
    ...
    var innerElement = React130.createElement(ElementType, _extends({}, contentRestProps, {
      className: classes,
      style: styles,
      ref: elementRef
    }), childrenUtils_exports.isNil(children) ? React130.createElement(React130.Fragment, null, PopupHeader_default.create(header, {
      autoGenerateKey: false
    }), PopupContent_default.create(content, {
      autoGenerateKey: false
    })) : children, hideOnScroll && React130.createElement(import_event_stack4.default, {
      on: hideOnScroll,
      name: "scroll",
      target: "window"
    }));
  ...
  var modifiers = [{
    ...
    // https://github.com/Semantic-Org/Semantic-UI-React/issues/4083
    {
      ...
      fn: function fn2(_ref2) {
        ...
        var definedZIndex = popper2 == null || (_popper$style = popper2.style) == null ? void 0 : _popper$style.zIndex;
  ...
  return React130.createElement(Portal_default, _extends({}, mergedPortalProps, {
    onClose: handleClose,
    onMount: handlePortalMount,
    onOpen: handleOpen,
    onUnmount: handlePortalUnmount,
...
var Progress = React131.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React131.createElement(ElementType, _extends({}, rest, {
    className: classes,
...
var RatingIcon = React132.forwardRef(function(props, ref2) {
  ...
  return React132.createElement(ElementType, _extends({
    role: "radio"
  }, rest, {
    className: classes,
    onClick: handleClick,
...
// node_modules/semantic-ui-react/dist/es/modules/Rating/Rating.js
var Rating = React133.forwardRef(function(props, ref2) {
  var className = props.className, _props$clearable = props.clearable, clearable = _props$clearable === void 0 ? "auto" : _props$clearable, disabled = props.disabled, icon = props.icon, _props$maxRating = props.maxRating, maxRating = _props$maxRating === void 0 ? 1 : _props$maxRating, size2 = props.size;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.rating,
    defaultState: props.defaultRating,
    initialState: 0
  }), rating = _useAutoControlledVal[0], setRating = _useAutoControlledVal[1];
  var _React$useState = React133.useState(-1), selectedIndex = _React$useState[0], setSelectedIndex = _React$useState[1];
  var _React$useState2 = React133.useState(false), isSelecting = _React$useState2[0], setIsSelecting = _React$useState2[1];
  ...
  return React133.createElement(ElementType, _extends({
    role: "radiogroup"
  }, rest, {
    className: classes,
    ...
    return (
      ...
      React133.createElement(RatingIcon_default, {
        tabIndex: disabled ? -1 : 0,
        active: rating >= i + 1,
...
function SearchCategoryLayout(props) {
  ...
  return React134.createElement(React134.Fragment, null, React134.createElement("div", {
    className: "name"
  }, categoryContent), React134.createElement("div", {
    className: "results"
  }, resultsContent));
}
...
// node_modules/semantic-ui-react/dist/es/modules/Search/SearchCategory.js
var SearchCategory = React135.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, content = props.content, _props$layoutRenderer = props.layoutRenderer, layoutRenderer = _props$layoutRenderer === void 0 ? SearchCategoryLayout_default : _props$layoutRenderer, _props$renderer = props.renderer, renderer = _props$renderer === void 0 ? function(_ref) {
    var name = _ref.name;
    return name;
  } : _props$renderer;
  ...
  return React135.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), layoutRenderer({
    categoryContent,
...
var defaultRenderer = function defaultRenderer2(_ref) {
  ...
  return [image && React136.createElement("div", {
    key: "image",
    className: "image"
    ...
    key: "content",
    className: "content"
  }, price && React136.createElement("div", {
    className: "price"
  }, price), title && React136.createElement("div", {
    className: "title"
  }, title), description && React136.createElement("div", {
    className: "description"
  }, description))];
};
defaultRenderer.handledProps = [];
var SearchResult = React136.forwardRef(function(props, ref2) {
  var active = props.active, className = props.className, _props$renderer = props.renderer, renderer = _props$renderer === void 0 ? defaultRenderer : _props$renderer;
  var handleClick = function handleClick2(e) {
    invoke_default(props, "onClick", e, props);
  };
  ...
  var ElementType = getComponentType_default(props);
  return React136.createElement(ElementType, _extends({}, rest, {
    className: classes,
    onClick: handleClick,
    ref: ref2
  }), renderer(props));
...
var SearchResults = React137.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("results transition", className);
  var rest = getUnhandledProps_default(SearchResults, props);
  var ElementType = getComponentType_default(props);
  return React137.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/modules/Search/Search.js
var _excluded2 = ["icon", "input", "minCharacters", "noResultsMessage", "showNoResults"];
var _excluded22 = ["childKey"];
var _excluded3 = ["childKey"];
...
var Search = React138.forwardRef(function(props, ref2) {
  var _props$icon = props.icon, icon = _props$icon === void 0 ? "search" : _props$icon, _props$input = props.input, input = _props$input === void 0 ? "text" : _props$input, _props$minCharacters = props.minCharacters, minCharacters = _props$minCharacters === void 0 ? 1 : _props$minCharacters, _props$noResultsMessa = props.noResultsMessage, noResultsMessage = _props$noResultsMessa === void 0 ? "No results found." : _props$noResultsMessa, _props$showNoResults = props.showNoResults, showNoResults = _props$showNoResults === void 0 ? true : _props$showNoResults, rest = _objectWithoutPropertiesLoose(props, _excluded2);
  return React138.createElement(SearchInner, _extends({
    icon,
    input,
    minCharacters,
    noResultsMessage,
...
var SearchInner = function(_Component) {
  ...
  function SearchInner2() {
    ...
    _this.getFlattenedResults = function() {
      ...
      return !category ? results : reduce_default(results, function(memo3, categoryData) {
        return memo3.concat(categoryData.results);
      }, []);
    };
    ...
    _this.renderNoResults = function() {
      ...
      return React138.createElement("div", {
        ...
        className: "header"
      }, noResultsMessage), noResultsDescription && React138.createElement("div", {
        className: "description"
      }, noResultsDescription));
    };
    _this.renderResult = function(_ref2, index, _array, offset2) {
      var childKey = _ref2.childKey, result = _objectWithoutPropertiesLoose(_ref2, _excluded22);
      if (offset2 === void 0) {
        offset2 = 0;
      }
      ...
      return React138.createElement(SearchResult_default, _extends({
    ...
    _this.renderCategories = function() {
      ...
      return map_default(categories, function(_ref3) {
        var childKey = _ref3.childKey, category = _objectWithoutPropertiesLoose(_ref3, _excluded3);
        ...
        return React138.createElement(SearchCategory_default, categoryProps, category.results.map(renderFn));
      });
    };
    ...
    _this.renderResultsMenu = function() {
      ...
      if (!menuContent)
        return;
      return React138.createElement(SearchResults_default, {
  ...
  _proto.render = function render() {
    ...
    return React138.createElement(ElementType, _extends({}, rest, {
      className: classes,
      onBlur: this.handleBlur,
      onFocus: this.handleFocus,
      onMouseDown: this.handleMouseDown,
...
var SidebarPushable = React140.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React140.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var SidebarPusher = React141.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React141.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
function useAnimationTick(visible) {
  ...
  var animationTick = React142.useRef(0);
  var forceUpdate = useForceUpdate();
  var currentTick = animationTick.current + tickIncrement;
  var resetAnimationTick = React142.useCallback(function() {
...
var Sidebar = React142.forwardRef(function(props, ref2) {
  var animation = props.animation, className = props.className, children = props.children, content = props.content, _props$direction = props.direction, direction = _props$direction === void 0 ? "left" : _props$direction, _props$target = props.target, target = _props$target === void 0 ? documentRef : _props$target, _props$visible = props.visible, visible = _props$visible === void 0 ? false : _props$visible, width = props.width;
  var _useAnimationTick = useAnimationTick(visible), animationTick = _useAnimationTick[0], resetAnimationTick = _useAnimationTick[1];
  var elementRef = useMergedRefs(ref2, React142.useRef());
  var animationTimer = React142.useRef();
  var skipNextCallback = React142.useRef();
  ...
  return React142.createElement(React142.Fragment, null, React142.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: elementRef
  }), childrenUtils_exports.isNil(children) ? content : children), visible && React142.createElement(EventListener, _extends({
...
var Sticky = React143.forwardRef(function(props, ref2) {
  var _stickyRect$current;
  var _props$active = props.active, active = _props$active === void 0 ? true : _props$active, _props$bottomOffset = props.bottomOffset, bottomOffset = _props$bottomOffset === void 0 ? 0 : _props$bottomOffset, children = props.children, className = props.className, context = props.context, _props$offset = props.offset, offset2 = _props$offset === void 0 ? 0 : _props$offset, _props$scrollContext = props.scrollContext, scrollContext = _props$scrollContext === void 0 ? isBrowser_default() ? window : null : _props$scrollContext, styleElement = props.styleElement;
  var _React$useState = React143.useState(false), sticky = _React$useState[0], setSticky = _React$useState[1];
  var _React$useState2 = React143.useState(), bound = _React$useState2[0], setBound = _React$useState2[1];
  var _React$useState3 = React143.useState(), bottom2 = _React$useState3[0], setBottom = _React$useState3[1];
  var _React$useState4 = React143.useState(), pushing = _React$useState4[0], setPushing = _React$useState4[1];
  var _React$useState5 = React143.useState(), top2 = _React$useState5[0], setTop = _React$useState5[1];
  var stickyRef = React143.useRef();
  var triggerRef = React143.useRef();
  var triggerRect = React143.useRef();
  var contextRect = React143.useRef();
  var stickyRect = React143.useRef();
  var frameId = React143.useRef();
  var ticking = React143.useRef();
  ...
  return React143.createElement(ElementType, _extends({}, rest, {
    className: containerClasses,
    ref: ref2
...
var TabPane = React144.forwardRef(function(props, ref2) {
  var _props$active = props.active, active = _props$active === void 0 ? true : _props$active, children = props.children, className = props.className, content = props.content, loading = props.loading;
  ...
  var ElementType = getComponentType_default(props, {
    defaultAs: Segment_default
  });
  var calculatedDefaultProps = {};
  if (ElementType === Segment_default) {
    calculatedDefaultProps.attached = "bottom";
  }
  return React144.createElement(ElementType, _extends({}, calculatedDefaultProps, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/modules/Tab/Tab.js
var _excluded4 = ["paneWidth", "tabWidth"];
var Tab = React145.forwardRef(function(props, ref2) {
  var _props$grid = props.grid, grid = _props$grid === void 0 ? {
    paneWidth: 12,
    tabWidth: 4
  } : _props$grid, _props$menu = props.menu, menu = _props$menu === void 0 ? {
    attached: true,
    tabular: true
  } : _props$menu, menuPosition = props.menuPosition, panes = props.panes, _props$renderActiveOn = props.renderActiveOnly, renderActiveOnly = _props$renderActiveOn === void 0 ? true : _props$renderActiveOn;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.activeIndex,
    defaultState: props.defaultActiveIndex,
    initialState: 0
  ...
  var renderVertical = function renderVertical2(menuElement2) {
    var paneWidth = grid.paneWidth, tabWidth = grid.tabWidth, gridProps = _objectWithoutPropertiesLoose(grid, _excluded4);
    var position = menuPosition || menuElement2.props.tabular === "right" && "right" || "left";
    return React145.createElement(Grid_default, gridProps, position === "left" && GridColumn_default.create({
      width: tabWidth,
  ...
  if (menuElement.props.vertical) {
    return React145.createElement(ElementType, _extends({}, rest, {
      ref: ref2
...
var Advertisement = React146.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React146.createElement(ElementType, _extends({}, rest, {
    className: classes,
    "data-text": test,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
...
var CardDescription = React147.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React147.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CardHeader = React148.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, textAlign = props.textAlign;
  ...
  var ElementType = getComponentType_default(props);
  return React148.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Card/CardContent.js
var CardContent = React150.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React150.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var CardGroup = React151.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React151.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  ...
  var itemsJSX = map_default(items, function(item) {
    ...
    return React151.createElement(Card_default, _extends({
      key
    }, item));
  });
  return React151.createElement(ElementType, _extends({}, rest, {
...
// node_modules/semantic-ui-react/dist/es/views/Card/Card.js
var Card = React152.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React152.createElement(ElementType, _extends({}, rest, {
      className: classes,
      href,
      onClick: handleClick,
      ref: ref2
  ...
  }), (description || header || meta) && React152.createElement(CardContent_default, {
    description,
    header,
    meta
  }), extra && React152.createElement(CardContent_default, {
    extra: true
  }, extra));
});
...
var CommentAction = React153.forwardRef(function(props, ref2) {
  ...
  return React153.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentActions = React154.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  var classes = clsx_m_default("actions", className);
  var rest = getUnhandledProps_default(CommentActions, props);
  var ElementType = getComponentType_default(props);
  return React154.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentAuthor = React155.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  var classes = clsx_m_default("author", className);
  var rest = getUnhandledProps_default(CommentAuthor, props);
  var ElementType = getComponentType_default(props);
  return React155.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentAvatar = React156.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React156.createElement(ElementType, _extends({}, rootProps, {
    className: classes,
    ref: ref2
  }), createHTMLImage(src, {
    autoGenerateKey: false,
...
var CommentContent = React157.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  var classes = clsx_m_default(className, "content");
  var rest = getUnhandledProps_default(CommentContent, props);
  var ElementType = getComponentType_default(props);
  return React157.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentGroup = React158.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React158.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentMetadata = React159.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  var classes = clsx_m_default("metadata", className);
  var rest = getUnhandledProps_default(CommentMetadata, props);
  var ElementType = getComponentType_default(props);
  return React159.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentText = React160.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  var classes = clsx_m_default(className, "text");
  var rest = getUnhandledProps_default(CommentText, props);
  var ElementType = getComponentType_default(props);
  return React160.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Comment/Comment.js
var Comment = React161.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React161.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var FeedDate = React162.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("date", className);
  var rest = getUnhandledProps_default(FeedDate, props);
  var ElementType = getComponentType_default(props);
  return React162.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var FeedExtra = React163.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React163.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var FeedLike = React164.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, icon = props.icon;
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return React164.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedMeta.js
var FeedMeta = React165.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React165.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var FeedUser = React166.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  ...
  return React166.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedSummary.js
var FeedSummary = React167.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React167.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedContent.js
var FeedContent = React168.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React168.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var FeedLabel = React169.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React169.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedEvent.js
var FeedEvent = React170.forwardRef(function(props, ref2) {
  ...
  return React170.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
    ...
    autoGenerateKey: false
  }), hasContentProp && React170.createElement(FeedContent_default, contentProps), children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Feed/Feed.js
var _excluded5 = ["childKey", "date", "meta", "summary"];
var Feed = React171.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React171.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  var eventElements = map_default(events, function(eventProps) {
    var childKey = eventProps.childKey, date = eventProps.date, meta = eventProps.meta, summary = eventProps.summary, eventData = _objectWithoutPropertiesLoose(eventProps, _excluded5);
    var finalKey = childKey != null ? childKey : [date, meta, summary].join("-");
    return React171.createElement(FeedEvent_default, _extends({
      date,
      key: finalKey,
      meta,
      summary
...
var ItemHeader = React172.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
  var rest = getUnhandledProps_default(ItemHeader, props);
  var ElementType = getComponentType_default(props);
  return React172.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ItemDescription = React173.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("description", className);
  var rest = getUnhandledProps_default(ItemDescription, props);
  var ElementType = getComponentType_default(props);
  return React173.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ItemExtra = React174.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("extra", className);
  var rest = getUnhandledProps_default(ItemExtra, props);
  var ElementType = getComponentType_default(props);
  return React174.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ItemMeta = React175.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("meta", className);
  var rest = getUnhandledProps_default(ItemMeta, props);
  var ElementType = getComponentType_default(props);
  return React175.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Item/ItemContent.js
var ItemContent = React176.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React176.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var _excluded6 = ["childKey"];
var ItemGroup = React177.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React177.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  ...
  var itemsJSX = map_default(items, function(item) {
    var childKey = item.childKey, itemProps = _objectWithoutPropertiesLoose(item, _excluded6);
    var finalKey = childKey != null ? childKey : [itemProps.content, itemProps.description, itemProps.header, itemProps.meta].join("-");
    return React177.createElement(Item_default, _extends({}, itemProps, {
      key: finalKey
    }));
  });
  return React177.createElement(ElementType, _extends({}, rest, {
...
var ItemImage = React178.forwardRef(function(props, ref2) {
  var size2 = props.size;
  var rest = getUnhandledProps_default(ItemImage, props);
  return React178.createElement(Image_default, _extends({}, rest, {
    size: size2,
    ui: !!size2,
    wrapped: true,
    ref: ref2
...
// node_modules/semantic-ui-react/dist/es/views/Item/Item.js
var Item = React179.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React179.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  return React179.createElement(ElementType, _extends({}, rest, {
    ...
    autoGenerateKey: false
  }), React179.createElement(ItemContent_default, {
    content,
    description,
    extra,
    header,
...
var StatisticGroup = React180.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React180.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
var StatisticLabel = React181.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("label", className);
  var rest = getUnhandledProps_default(StatisticLabel, props);
  var ElementType = getComponentType_default(props);
  return React181.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var StatisticValue = React182.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  return React182.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Statistic/Statistic.js
var Statistic = React183.forwardRef(function(props, ref2) {
  ...
  var ElementType = getComponentType_default(props);
  if (!childrenUtils_exports.isNil(children)) {
    return React183.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
